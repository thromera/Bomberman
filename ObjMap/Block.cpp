...
namespace ObjMap
{
  ...
  {
    this->texture_ = gdl::Image::load("Textures/brick.jpg");
  }

  void Block::initialize(float const & x, float const & y, float const & z)
  {
    this->pos_.setPos(x, y, z);
  }

  void Block::update(gdl::GameClock const & gameClock, gdl::Input & input)
  {
    (void) gameClock;
    (void) input;
  }
